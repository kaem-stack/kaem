...
//!
//! The hybrid scheme is for first contact: it does a fresh KEM encapsulation
//! per call to agree a key, which makes it unsuitable as a reusable key
//! store. Once two parties already share a key — e.g. a chatroom key minted
//! once by a pairing handshake — there's no KEM step left to do; this module
//! just runs the AEAD directly.
//!
//! # Wire format
//!
//! ```text
